  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
        <div style={{ width: 8, height: 8, borderRadius: '50%', background: item.payload.color, boxShadow: `0 0 6px ${item.payload.color}` }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 7, marginTop: 4 }}>
            {chartData.map(entry => (
              <div key={entry.key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{ width: 56, height: 3, borderRadius: 3, background: 'rgba(255,255,255,0.07)', overflow: 'hidden' }}>
                    <div style={{
                  ...
                  <span style={{ color: '#e2e8f0', fontSize: 12, fontWeight: 700, minWidth: 18, textAlign: 'right' }}>
                    {entry.value}
                  </span>
                </div>
              </div>
