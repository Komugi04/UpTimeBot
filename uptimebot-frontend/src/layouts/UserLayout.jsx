...
import { LayoutDashboard, MonitorCheck, AlertCircle, LogOut } from 'lucide-react';
...
export default function UserLayout() {
  ...
  const navItems = [
    ...
    { icon: MonitorCheck, label: 'My Monitors', path: '/user/monitors' },
    { icon: AlertCircle, label: 'Incidents', path: '/user/incidents' },
  ];
